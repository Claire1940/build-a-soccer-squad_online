...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Build A Soccer Squad Wiki",
    description: "Read the Terms of Service for Build A Soccer Squad Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Build A Soccer Squad Wiki",
      description: "Terms and conditions for using Build A Soccer Squad Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Build A Soccer Squad Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Build A Soccer Squad Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Build A Soccer Squad Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Build A Soccer Squad Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Build A Soccer Squad". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Codes status and redemption guides</li>
              <li>Tier list and best player rankings</li>
              <li>Players database and captain walkthroughs</li>
              <li>Cup Mode and chemistry strategies</li>
              <li>Shop, rerolls, and resource guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Build A Soccer Squad Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Build A Soccer Squad. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Build A Soccer Squad Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Build A Soccer Squad. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game updates, Cup Mode changes, and content rotations may occur without notice. We are not responsible for in-game changes or feature availability.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BUILD A SOCCER SQUAD WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, YouTube, and other community platforms,
            ...
            <p>
              ...
              you and Build A Soccer Squad Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@build-a-soccer-squad.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@build-a-soccer-squad.online</a>
            </p>
            <p>
