...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Build A Soccer Squad Wiki',
    description: 'Copyright and intellectual property information for Build A Soccer Squad Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Build A Soccer Squad Wiki',
      description: 'Copyright and intellectual property information for Build A Soccer Squad Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Build A Soccer Squad Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Build A Soccer Squad Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Build A Soccer Squad Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Build A Soccer Squad Developers (Bloxheed)</strong> - Creators of the Build A Soccer Squad game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Build A Soccer Squad</strong> - Trademark of the game developers</li>
              <li><strong>Build A Soccer Squad Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Build A Soccer Squad Wiki.
            </p>
            ...
            <p>
              ...
              Build A Soccer Squad Wiki<br />
              Email: <a href="mailto:dmca@build-a-soccer-squad.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@build-a-soccer-squad.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Build A Soccer Squad Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Build A Soccer Squad Wiki (build-a-soccer-squad.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@build-a-soccer-squad.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@build-a-soccer-squad.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@build-a-soccer-squad.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@build-a-soccer-squad.online</a>
            </p>
            <p>
